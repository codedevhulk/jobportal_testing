...
export const getJobseekerProfileAction = createAsyncThunk("getJobseekerProfileAction", async () => {
  try {
...
export const jobApplicatonsOfJobseekerAction = createAsyncThunk("jobApplicationsOfJobseeker", async () => {
